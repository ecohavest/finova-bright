...
import { BANKS_GLOBAL } from "@/lib/banks";

const WireTransferPage = ({ userHasCards }: { userHasCards: boolean }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setIsSending(true);
    console.log("Mock wire transfer", { accountNumber, bank });
  };
          ...
          <div className="container mx-auto px-4 py-8">
            <div className="max-w-2xl mx-auto text-center">
              ...
              <p className="text-blue-200 dark:text-blue-300 text-lg">
                Send money to a bank account in another country
              </p>
            </div>
          </div>
        </div>
